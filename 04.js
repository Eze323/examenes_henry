...
function sumArray(array, n) {
  // La función llamada 'sumArray' recibe como argumento un arreglo de números 
  // ordenados llamado 'array' y un número entero llamdo 'n' y debe 
  // devolver true si alguna combinación de dos números cualesquiera del arreglo sumados
  ...
  for(i=0;i<array.length-2;i++){
     ...
     for(h=1;h<array.length-1;h++){
        
        //console.log(array[i]+' i - h :'+array[h]);
        if(array[i]+array[h]===n){
          laSumaDa=true;
          return laSumaDa;
        }
    }
